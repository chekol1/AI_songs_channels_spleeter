"""SoniCloud Spleeter worker - FIXED version.

Fixes vs. the original:
  1. `import shutil` was missing (crash on zipping step)
  2. `if __name__ == "__main__"` was malformed
  3. Queue URL / bucket / region come from env vars (with the old values as defaults)
...
QUEUE_URL = os.environ.get(
    "QUEUE_URL",
    "https://sqs.us-east-1.amazonaws.com/010686621615/music-jobs-queue",
)
RESULT_BUCKET = os.environ.get(
    "RESULT_BUCKET",
    "sonic-cloud-music-results-010686621615",
)
